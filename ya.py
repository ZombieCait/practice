...
"""
Посетитель кинотеатра заходит в зал и выбирает себе место, при этом он хочет сесть как можно дальше от соседей.
В ряду есть как минимум 1 сосед. Найти место с максимальным расстоянием до ближайшего соседа.
На вход подается список [1, 0, 0, 0, 1, 1, 0, 1], 1 - занятые места, 0 - свободные
"""
